...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
	...
	{ "setstakesplitthreshold", &setstakesplitthreshold, false,  false , false},
	{ "getstakesplitthreshold", &getstakesplitthreshold, false,  false , false},
	{ "rescanfromblock", 		&rescanfromblock, 		 false,  false , false},
	...
	{ "getstaketx",             &getstaketx,             false,  false , false},
	{ "deleteaddress",          &deleteaddress,          false,  false , false},
    ...
    { "stakeforcharity",        &stakeforcharity,        false,  false , false},
    ...
    { "resendwallettransactions", &resendwallettransactions, false,  true , false},
    { "makekeypair",            &makekeypair,            false,  true , false},
    { "sendalert",              &sendalert,              false,  false , false},
	{ "multisend",              &multisend,              false,  false , false},
	{ "cclistcoins", 			&cclistcoins, 			 false,  false , false},
	{ "ccselect",        		&ccselect,               false,  false , false},
	{ "cclistselected",        	&cclistselected,         false,  false , false},
    { "ccreturnchange",        	&ccreturnchange,         false,	false , false},
    { "cccustomchange",        	&cccustomchange,         false,	false , false},
    { "ccreset",        		&ccreset,                false,	false , false},
	{ "ccsend",		        	&ccsend,                 false,	false , false},
	{ "getweight",        		&getweight,              false,	false , false},
	{ "getconfs",        		&getconfs,               false,	false , false},
	{ "hashsettings",        	&hashsettings,           false, false , false},
    { "importaddress",          &importaddress,          false,  false , false},
    { "fundrawtransaction",     &fundrawtransaction,     false, false , false},
    { "getrawchangeaddress",    &getrawchangeaddress,    true,   false, true },
    {"abandontransaction",     &abandontransaction,      false, false,  false }
};
...
std::string HelpExampleCli(string methodname, string args){
    return "> ABBCOIND " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27464/\n";
}
