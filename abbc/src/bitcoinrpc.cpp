...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
    ...
    {"listreceivedbylabel",     &listreceivedbylabel,  false, false},
    ...
    {"fundrawtransaction",      &fundrawtransaction,     false, false},
    {"importpubkey",            &importpubkey,           false, false},
    {"abortrescan",             &abortrescan,            true, false},
    {"getaddressesbylabel",     &getaddressesbylabel,         true, false},
    {"listlabels",              &listlabels,              false, false },
};
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "listlabel"              && n > 0) ConvertTo<boost::int64_t>(params[0]);
