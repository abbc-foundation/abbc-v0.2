...
public:
    ...
    //mutable CWaitableCriticalSection  cs_wallet;
    bool fFileBacked;
    ...
    void ReturnAbortRescan() { fAbortRescan = false; }
...
public:
    ...
    bool GetReservedKey1(CPubKey &pubkey);
    void KeepKey();
};
...
public:
    ...
    bool IsConfirmed() const
    {
		...
		//presstab ABBCCoin, removed code that checks walletdb for confirmation, we want blockchain info only
